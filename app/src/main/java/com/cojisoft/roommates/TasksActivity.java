...
public class TasksActivity extends BaseActivity implements ActionBar.TabListener, OnListChangedListener
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		fragments = new TasksFragment[2];
		fragments[0] = TasksFragment.newInstance();
		fragments[1] = TasksFragment.newInstance();
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter 
	{
		...
		//	fragments[position] = GroceriesFragment.newInstance();
			...
			args.putInt(TasksFragment.ARG_SECTION_NUMBER, position + 1);
			args.putBoolean(TasksFragment.ARG_SPECIAL_LIST, position == 0 ? true : false);
