...
public class BillsActivity extends BaseActivity implements ActionBar.TabListener, OnListChangedListener
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		fragments = new BillsFragment[2];
		fragments[0] = BillsFragment.newInstance();
		fragments[1] = BillsFragment.newInstance();
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter 
	{
		...
		//	fragments[position] = GroceriesFragment.newInstance();
			...
			args.putInt(BillsFragment.ARG_SECTION_NUMBER, position + 1);
			args.putBoolean(BillsFragment.ARG_SPECIAL_LIST, position == 0 ? true : false);
